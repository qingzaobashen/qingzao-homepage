...
4. Design determines construction and materials; construction and materials affect the result.
...
4. Doors and windows: check appearance, whether they open smoothly, and any damage or missing parts.
5. Floor and walls: tap with the hollow-spot hammer for hollow spots; look for cracks.
6. Putty: if walls are already painted with putty, wet a spot to see if it rubs off — this tells you if it's waterproof putty (which need not be scraped off).
7. Water lines: pour a basin of water to test drainage; check that pipes are secure and intact.
8. Holes: check the exhaust duct, AC holes, and outdoor unit positions are reasonable.
...
4. Record living needs: who you live with, habits, hobbies, cooking style, laundry frequency — note everything.
5. Distinguish reactive aesthetics (sensory, no right or wrong) from reflective aesthetics (deep thinking, with hierarchy).
...
4. Doors & windows: balcony enclosures, window modifications, security door, entry door (not bedroom or bathroom doors).
5. Main materials:
   1) Doors: kitchen, bedroom, bathroom, balcony doors, etc.
   2) Floor: tiles, flooring, baseboards, epoxy grout.
   3) Walls: tiles, ceramic tiles, wallpaper, latex paint.
   4) Sanitary ware, fixtures, lighting, switches.
6. Whole-house built-in cabinetry: kitchen cabinets, shoe cabinets, wardrobes, wine cabinets, TV cabinets, sideboards, balcony cabinets, custom desks, tatami, etc.
7. Finished furniture: sofa, coffee table, dining table, chairs, mattress, etc.
8. Appliances: TV, fridge, washer, range hood & cooktop, AC, water dispenser, microwave, water heater, etc.
9. Home decor: art, rugs, vases, etc.
10. Total budget = hard renovation (base construction + main materials) + soft furnishing (furniture, cabinets) + appliances, roughly in a 4:3:3 ratio.
11. Money-saving principles: value cost-performance, user experience, maintenance cost, and safety cost.
12. The renovation market is mostly one-time service; renovation companies usually don't handle long-term after-sales.
